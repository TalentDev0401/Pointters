...
class AAPlayButton: UIButton {
    ...
    fileprivate func setPauseIconImage(_ rect: CGRect) {
       ...
       // context.setStrokeColor(UIColor(red: 76/255, green: 169/255, blue: 222/255, alpha: 1).cgColor)
    ...
    fileprivate func setPlayIconImage(_ rect: CGRect) {
        ...
        UIGraphicsBeginImageContext(rect.size)
        let context = UIGraphicsGetCurrentContext()!
        context.setFillColor(UIColor(red: 255/255, green: 255/255, blue: 255/255, alpha: 1).cgColor)
