...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    open var optionCalendarBackgroundColorTodayHighlight = UIColor(hexString: "#26b3ff")
    ...
    open var optionCalendarBackgroundColorPastDatesHighlight = UIColor(hexString: "#26b3ff")
    ...
    open var optionCalendarBackgroundColorFutureDatesHighlight = UIColor(hexString: "#26b3ff")
    open var optionCalendarBackgroundColorFutureDatesFlash = UIColor.white
    open var optionCalendarUnderlinedBackgroundColor = UIColor(hexString: "#f98f17")
    ...
    open var optionClockBackgroundColorAMPMHighlight = UIColor(hexString: "#26b3ff")
    ...
    open var optionClockBackgroundColorHourHighlight = UIColor(hexString: "#26b3ff")
    open var optionClockBackgroundColorHourHighlightNeedle = UIColor(hexString: "#26b3ff")
    ...
    open var optionClockBackgroundColorMinuteHighlight = UIColor(hexString: "#26b3ff")
    open var optionClockBackgroundColorMinuteHighlightNeedle = UIColor(hexString: "#26b3ff")
    ...
    open var optionButtonTitleDone: String = "Set"
    ...
    open var optionButtonFontColorCancel = UIColor(hexString: "#26b3ff")
    open var optionButtonFontColorDone = UIColor(hexString: "#26b3ff")
    ...
    open var optionTopPanelBackgroundColor = UIColor(hexString: "#f98f17")
    ...
    open var optionSelectorPanelBackgroundColor = UIColor(hexString: "#f98f17").withAlphaComponent(0.9)
    ...
    @objc internal func didRotateOrNot(animated: Bool = true) {
        ...
        if orientation == .landscapeLeft || orientation == .landscapeRight || orientation == .portrait || orientation == .portraitUpsideDown {
            ...
            topContainerHeightConstraint.constant = 180//isPortrait ? portraitTopContainerHeight : optionShowTopContainer ? landscapeContainerHeight : 0
            bottomContainerWidthConstraint.constant = isPortrait ? portraitContainerWidth : landscapeBottomContainerWidth
            bottomContainerHeightConstraint.constant = 400//isPortrait ? portraitBottomContainerHeight : landscapeContainerHeight
        ...
        if detail.type == .date {
            ...
            if let touch = touches.sorted(by: { $0.timestamp < $1.timestamp }).last {
                ...
                if dateTapped.month == detail.startDate.month && delegate.WWCalendarRowDateIsEnable(dateTapped){
                    if dateTapped.compare(Date().beginningOfDay) == ComparisonResult.orderedAscending {
                    } else {
